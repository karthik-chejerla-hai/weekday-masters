...
- Sessions can be canceled for a reason
...
- Four notification categories: session reminders, RSVP deadlines, waitlist updates, admin announcements
...
- `POST /api/admin/announcements` — Send an announcement
